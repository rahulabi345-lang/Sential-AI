    ...
    if recent_threats:
        ...
        for threat in recent_threats:
            ...
            with st.container(border=True):
                ...
                current_status = threat.status.value
                ...
                selected_status = st.selectbox(
                    ...
                    status_options,
                    index=current_index,
                    key=f"status_{threat.threat_id}",
                )

                if st.button(
                    "Update Status",
                    key=f"update_{threat.threat_id}",
                ):
                    ...
                    try:
                        ...
                        if updated:
                            ...
                            st.error(
                                "Threat status could not be updated."
                            )

                    except Exception as exc:

                        st.error(
                            "Failed to update threat status."
                        )
